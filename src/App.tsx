...
const App = (props: AppProps) => {
  ...
  const appliedParamState = getMergedParamState(
    paramState,
    setParamState,
    monologueController
  );
  const setParamViaCallback = getMergedParamStateForCallback(
    paramState,
    setParamState,
    monologueController
  );
  ...
  monologueController.onParameterChange(
    Parameters.VCO1_WAVE,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.VCO1_SHAPE,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.VCO1_LEVEL,
    appliedParamState
  );

  monologueController.onParameterChange(
    Parameters.VCO2_WAVE,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.VCO2_SHAPE,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.VCO2_PITCH,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.VCO2_OCTAVE,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.VCO2_LEVEL,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.VCO2_DUTY,
    appliedParamState
  );

  monologueController.onParameterChange(
    Parameters.LFO_TARGET,
    appliedParamState
  );
  ...
  monologueController.onParameterChange(
    Parameters.LFO_INTENSITY,
    appliedParamState
  );

  monologueController.onParameterChange(Parameters.ENV_TYPE, appliedParamState);
  monologueController.onParameterChange(
    Parameters.ENV_TARGET,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.ENV_ATTACK,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.ENV_DECAY,
    appliedParamState
  );
  monologueController.onParameterChange(
    Parameters.ENV_INTENSITY,
    appliedParamState
  );
    ...
    <div className="App">
      <div className="section-wrapper">
        <div className="panel">
          ...
          <Panel
            setParamViaCallback={setParamViaCallback}
